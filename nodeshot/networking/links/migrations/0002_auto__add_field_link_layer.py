...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.layer'
        db.add_column(u'links_link', 'layer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['layers.Layer'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.layer'
        db.delete_column(u'links_link', 'layer_id')
