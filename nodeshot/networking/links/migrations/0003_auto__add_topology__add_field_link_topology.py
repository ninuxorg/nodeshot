...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'links_topology', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 15, 0, 0))),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 15, 0, 0))),
        ...
        db.send_create_signal('links', ['Topology'])

        # Adding field 'Link.topology'
        db.add_column(u'links_link', 'topology',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['links.Topology'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Topology'
        db.delete_table(u'links_topology')

        # Deleting field 'Link.topology'
        db.delete_column(u'links_link', 'topology_id')
    ...
    models = {
        ...
        'layers.layer': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 15, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 15, 0, 0)'}),
        ...
        'links.link': {
            ...
            'topology': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['links.Topology']", 'null': 'True', 'blank': 'True'}),
        ...
        'profiles.profile': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 15, 0, 0)'}),
