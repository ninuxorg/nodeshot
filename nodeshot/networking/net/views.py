...
class NodeDeviceList(generics.ListCreateAPIView):
    """
...
class BaseInterfaceList(generics.ListCreateAPIView):
    """
...
class InterfaceIpList(generics.ListCreateAPIView):
    """
    ...
    def perform_create(self, serializer):
        serializer.save(interface=self.interface)
