...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('layers_layer', (
            ...
            ('added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 2, 0, 0))),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 2, 0, 0))),
