...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('layers_layer', (
            ...
            ('added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 23, 0, 0))),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 23, 0, 0))),
        ...
        db.create_table('layers_layer_mantainers', (
        ...
        db.create_unique('layers_layer_mantainers', ['layer_id', 'profile_id'])

        # Adding model 'LayerExternal'
        db.create_table('layers_external', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('layer', self.gf('django.db.models.fields.related.OneToOneField')(related_name='external', unique=True, to=orm['layers.Layer'])),
            ('interoperability', self.gf('django.db.models.fields.CharField')(default=False, max_length=128)),
            ('config', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('map', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('layers', ['LayerExternal'])

        # Adding model 'LayerParticipationSettings'
        db.create_table('participation_layer_settings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('layer', self.gf('django.db.models.fields.related.OneToOneField')(related_name='layer_participation_settings', unique=True, to=orm['layers.Layer'])),
            ('voting_allowed', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('rating_allowed', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('comments_allowed', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('layers', ['LayerParticipationSettings'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('layers_layer_mantainers')

        # Deleting model 'LayerExternal'
        db.delete_table('layers_external')

        # Deleting model 'LayerParticipationSettings'
        db.delete_table('participation_layer_settings')
