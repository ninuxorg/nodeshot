...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Layer.zoom'
        db.delete_column(u'layers_layer', 'zoom')


    def backwards(self, orm):
        # Adding field 'Layer.zoom'
        db.add_column(u'layers_layer', 'zoom',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=12),
                      keep_default=False)
