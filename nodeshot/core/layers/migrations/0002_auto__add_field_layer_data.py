...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.data'
        db.add_column('layers_layer', 'data',
                      self.gf('django_hstore.fields.DictionaryField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.data'
        db.delete_column('layers_layer', 'data')
    ...
    models = {
        ...
        'layers.layer': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 2, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 2, 0, 0)'}),
        ...
        'profiles.profile': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 2, 0, 0)'}),
