...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Layer.minimum_distance'
        db.delete_column(u'layers_layer', 'minimum_distance')

        # Adding field 'Layer.nodes_minimum_distance'
        db.add_column('layers_layer', 'nodes_minimum_distance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Layer.minimum_distance'
        db.add_column(u'layers_layer', 'minimum_distance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Layer.nodes_minimum_distance'
