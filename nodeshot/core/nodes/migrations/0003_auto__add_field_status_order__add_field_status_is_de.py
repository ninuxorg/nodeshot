...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('nodes_status', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Status.is_default'
        db.add_column('nodes_status', 'is_default',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('nodes_status', 'order')

        # Deleting field 'Status.is_default'
        db.delete_column('nodes_status', 'is_default')
    ...
    models = {
        ...
        'layers.layer': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 1, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 1, 0, 0)'}),
        ...
        'profiles.profile': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 1, 0, 0)'}),
