...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'nodes_node', 'coords', 'geometry')
        db.alter_column('nodes_node', 'geometry', models.GeometryField())


    def backwards(self, orm):
        db.rename_column(u'nodes_node', 'geometry', 'coords')
        db.alter_column('nodes_node', 'coords', models.PointField())
    ...
    models = {
        ...
        'layers.layer': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 11, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 11, 0, 0)'}),
        ...
        'nodes.node': {
            ...
            'data': ('django_hstore.fields.DictionaryField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'profiles.profile': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 11, 0, 0)'}),
