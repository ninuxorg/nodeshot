/**
 * WARNING: THIS VERSION DIFFERS SLIGHTLY FROM THE ORIGINAL SCRIPT - my email is federico[at]nemesisdesign[dot]net
 * MODIFICATIONS ARE ANTICIPATED BY COMMENTS CONTAINING "EDIT BY NEMESIS"
 * jQuery Formset 1.2
...
;(function($) {
            ...
            insertDeleteLink = function(row) {
                ...
                row.find('a.' + options.deleteCssClass).click(function() {
                    ...
                    if (del.length) {
                        ...
                        // BEGIN EDIT BY NEMESIS                        
                        if(options.formContainerClass){
                            //var forms = $(this).parents('.'+options.formContainerClass).find('.dynamic-form').not('.formset-custom-template');
                            var parent = $(this).parents('.'+options.formContainerClass);
                        }
                        else{
                            var parent = $('.' + options.formCssClass).parent();
                        }
                        row.remove();
                        var forms = parent.find('.dynamic-form').not('.formset-custom-template');                        
                        // END EDIT                        
    ...
    $.fn.formset.defaults = {
        ...
        // EDIT BY NEMESIS
        formContainerClass: false        // This is needed when having multiple formset in the same page. Insert the class of the HTML element that contains each of the different database objects, for example 'tab' (if you are using tabs).
    };
})(jQuery)